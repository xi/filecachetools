...
class TestCacheBase(unittest.TestCase):
    ...
    def setUp(self):
        filecachetools.CACHE_DIR = '/tmp/cache-%i' % randint(1000, 10000)

    def tearDown(self):
        rmtree(filecachetools.CACHE_DIR)


class TestBaseCache(TestCacheBase):
    def test_dir_exists(self):
        os.makedirs(os.path.join(filecachetools.CACHE_DIR, 'test'))
        cache = self.cache_class('test', 1000)
        cache['key'] = 'value'
    ...
    def test_missing(self):
        ...
        cache = self.cache_class('test', 1000, missing=fn)
    ...
    def test_expire(self):
        cache = self.cache_class('test', 1000, ttl=1)
        cache['key1'] = 'value1'
        sleep(2)
